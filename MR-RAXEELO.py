...
\033[1;97m     
\033[1;97m----------------------------------------------------------------------------------------
\033[1;97m(~) AUTHOR  : RAXEELO
\033[1;97m(~) GITHUB  : 
\033[1;97m(~) LIFE LINE : ESHAL YOUZSAFZAI
\033[1;97m-----------------------------------------------------------------------------------------
"""
...
def main():
    ...
    os.system("clear")
    print(abm)
    print("\033[1;97m[\033[1;93m1\033[1;97m] Install login tool for cloning")
    time.sleep(0.05)
    print("\033[1;97m[\033[1;93m2\033[1;97m] Install  extracting tool")
    time.sleep(0.05)
